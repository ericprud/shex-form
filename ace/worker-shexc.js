...
ace.define("ace/mode/shex/shex-core-browserify.js",[], function(require, exports, module) {
  ...
  this._validateShape = function (db, point, regexEngine, shape, shapeLabel, tracker, seen) {
    ...
    var tripleList = constraintList.reduce(function (ret, constraint, ord) {
      ...
      var matchConstraints = _ShExValidator._triplesMatchingShapeExpr(
        ...
        constraint.inverse, _errorsByShapeLabel, _errorsByShapeExpr
      );
...
},{"../lib/regex/nfax-val-1err":9,"../lib/regex/threaded-val-nerr":10,"./RdfTerm":5,"./ShExUtil":6,"_process":2}],8:[function(require,module,exports){
...
ace.define("ace/mode/shex/shex-parser-browserify.js",[], function(require, exports, module) {
var $build_deps$ = {require: require, exports: exports, module: module};
exports = undefined; module = undefined;
function define(name, deps, m) {
    if (typeof name == "function") {
...
ace.define("ace/mode/shexc_worker",[], function(require, exports, module) {
"use strict";
...
(function() {
    ...
    this.onUpdate = function() {
      ...
      var errors = [];
      try {
        ShExParser.parse(value);
      } catch (e) {console.warn(e);
        if ("errors" in e) {
          e.errors.forEach(processError);
        } else {
          processError(e);
        }
      }
      ...
      function processError (e) {
        let [row, column] = "hash" in e ? [e.hash.loc.first_line - 1, e.hash.loc.first_column] : [1, 1];
        let text = e.message;
        let type = "error";
        errors.push({row, column, text, type})
      }
    };
